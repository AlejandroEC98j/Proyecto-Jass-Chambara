...
@section('content')
    <div class="bg-white p-6 rounded shadow-md max-w-lg mx-auto">
        <h1 class="text-2xl font-bold mb-6 text-center text-gray-700">Registrar Nuevo Medidor</h1>
        ...
        <form action="{{ route('medidores.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="numero_serie" value="{{ old('numero_serie') }}" class="w-full border border-gray-300 px-4 py-2 rounded focus:ring focus:ring-blue-200" required>
            </div>
            ...
            <div>
                ...
                <input type="number" name="lectura_actual" value="{{ old('lectura_actual') }}" class="w-full border border-gray-300 px-4 py-2 rounded focus:ring focus:ring-blue-200" required>
            </div>

            <div>
                <label class="block font-medium text-gray-700">Dirección</label>
                <input type="text" name="direccion" value="{{ old('direccion') }}" class="w-full border border-gray-300 px-4 py-2 rounded focus:ring focus:ring-blue-200" required>
            </div>
