...
@section('title', 'Registrar Medidor')

@section('content')
    <div class="max-w-6xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        <h2 class="text-2xl font-bold text-center mb-6 text-cyan-600">{{ __('Registrar Nuevo Medidor') }}</h2>
        ...
        <form action="{{ route('medidores.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="numero_serie" value="{{ old('numero_serie') }}" class="w-full border border-gray-300 px-4 py-3 rounded-md focus:ring focus:ring-cyan-300" required>
            </div>
            ...
            <div>
                ...
                <input type="number" name="lectura_actual" value="{{ old('lectura_actual') }}" class="w-full border border-gray-300 px-4 py-3 rounded-md focus:ring focus:ring-cyan-300" required>
            </div>

            <div>
                <label class="block font-medium text-gray-700">Dirección</label>
                <input type="text" name="direccion" value="{{ old('direccion') }}" class="w-full border border-gray-300 px-4 py-3 rounded-md focus:ring focus:ring-cyan-300" required>
            </div>
